        ...
        <AuthBg>
            <AuthContainer>
                ...
                <div className="info grid bg-[#000000e6] rounded-[30px] pt-[35px] pb-[34px] px-[34px] text-center">
                    <h1 className="text-[26px] font-bold">Sign Up</h1>
                    ...
                    <div className="flex justify-center gap-[10px] text-[14px] pt-[11px]">Have an account?<Link href={'./signin'} className="text-[#6cded3] underline">Sign in</Link></div>
                </div>
            </AuthContainer>
        </AuthBg>
    );
